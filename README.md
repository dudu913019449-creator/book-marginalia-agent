...
在 Mac 的 Apple Books 里划一句，然后说“就这句”，Agent 会生成：原意、与你有关、反面一问、带走什么。说“存一下”才会保存划线；说“生成今日札记”会读取当天已保存的划线并展示综合结果，但不会自动落盘。只有再说“保存今日札记”，才会写入 `daily/YYYY-MM-DD.md`，并且默认绝不覆盖已有札记。
